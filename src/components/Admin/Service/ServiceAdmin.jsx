...
const ServiceAdmin = () => {
  ...
  const postProduct = (e) => {
    ...
    const UPLOAD_URL =
      "https://omepc-server.onrender.com/api/omEpc/service/new";
              ...
              >
                <div className="my-2">
                  ...
                  >
                    ...
                    <option className="capitalize" value="ups">
                      Ups
                    </option>
                    <option className="capitalize" value="printer">
                      Printer
                    </option>
                    <option className="capitalize" value="survillence">
                      Surveillance
                    </option>
