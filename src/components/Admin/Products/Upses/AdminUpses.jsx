...
const AdminUpses = () => {
  ...
  const postProduct = (e) => {
    ...
    const UPLOAD_URL =
      "https://omepc-server.onrender.com/api/omEpc/product/ups/new";
          ...
          <div className="modal modal-bottom sm:modal-middle ">
            <div className="modal-box text-center">
              ...
              >
                ...
                <input
                  name="outputPlugsNumber"
                  onChange={(e) => setOutputPlugsNumber(e.target.value)}
                  type="number"
                  required
                  placeholder="Output Plugs Number*"
                  className="my-2 input input-bordered w-full max-w-lg rounded-none"
                />
                ...
                <input
                  name="batteriesNumber"
                  onChange={(e) => setBatteriesNumber(e.target.value)}
                  type="number"
                  required
                  placeholder="Batteries Number*"
                  className="my-2 input input-bordered w-full max-w-lg rounded-none"
                />
