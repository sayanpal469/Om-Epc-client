...
import AdminAccesoriesRaw from "./AdminAccesoriesRaw";

const AdminAccesories = () => {
  ...
  const postProduct = (e) => {
    ...
    const UPLOAD_URL =
      "https://omepc-server.onrender.com/api/omEpc/product/accesories/new";
...
export default AdminAccesories;
