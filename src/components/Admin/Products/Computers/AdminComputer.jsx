...
const AdminComputer = () => {
  ...
  const postProduct = (e) => {
    ...
    const UPLOAD_URL =
      "https://omepc-server.onrender.com/api/omEpc/product/computer/new";
        ...
        <div>
          ...
          <div className="modal modal-bottom sm:modal-middle ">
            <div className="modal-box text-center">
              <label
                htmlFor="addModal"
                className="btn btn-md btn-circle bg-red-500 border-0 absolute right-2 top-2 text-xl mt-2"
              >
                ✕
              </label>
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) => setProcessorFrequency(e.target.value)}
                  type="text"
                ...
                <textarea
                  ...
                  className="my-2 textarea textarea-bordered textarea-lg w-full max-w-lg"
                />

                <input
                  className="btn capitalize bg-orange-500 border-none rounded-none"
                  type="submit"
                  value="Submit"
                />
              </form>
