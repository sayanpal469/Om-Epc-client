            ...
            <div>
                ...
                <div className="px-4 py-3 w-72">
                    ...
                    <div className="flex items-center">
                        ...
                        <button onClick={() => getDetails(_id)} className="ml-auto btn rounded-full bg-white hover:bg-gray-100 text-black border-0"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
