                ...
                <a onClick={() => (window.location.href = 'tel:917981413743')} className="ml-2 cursor-pointer text-gray-500">
                  ...
                  >
                    ...
                    <div className="lg:flex mt-5 lg:items-center justify-between space-y-3 lg:space-y-2">
                        ...
                        <button onClick={() => handelBuyClick(refurId)} className="text-white btn capitalize bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-700 rounded">Buy Now</button>
                    </div>
                </div>
            </div>}
        </div>
