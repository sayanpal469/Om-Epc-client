        ...
        <div className="w-72 bg-white rounded-xl duration-500 hover:scale-105 hover:shadow-md">
            <div>
                ...
                <div className="px-4 py-3 w-72">
                    ...
                    <p title={modelName} className="text-lg font-semibold text-black truncate block capitalize">{modelName}</p>
                    <div className="flex items-center">
                        <p className="text-lg font-semibold text-black cursor-auto my-3">₹{price}</p>
                        <del>
                            <p className="text-sm text-gray-600 cursor-auto ml-2">₹{wrongPrice}</p>
                        </del>
                        <button onClick={() => getDetails(_id)} className="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
