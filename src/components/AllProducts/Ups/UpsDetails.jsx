    ...
    const fetchData = async () => {
      ...
      try {
        let { data, status } = await axios.get(
          `https://omepc-server.onrender.com/api/omEpc/product/ups/${upsId}`
        );
