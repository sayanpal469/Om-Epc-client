    ...
    return (
        <div class="container px-14 py-24 mx-auto">
            ...
            {!loading && <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 space-x-5">
                <img alt="ecommerce" class="w-[80%] mx-auto object-cover object-center rounded" src={imgUrl} />
                <div class="w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    {/* <h2 class="text-sm title-font text-gray-500 tracking-widest">{brand}</h2> */}
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{brand} {modelNumber} {modelName} UPS</h1>
                    <div class="flex mb-4">
                    ...
                    <div class="lg:flex mt-5 lg:items-center justify-between space-y-3 lg:space-y-2">
                        ...
                        <button onClick={() => handelBuyClick(upsId)} class="text-white btn capitalize bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-700 rounded">Buy Now</button>
                    </div>
                </div>
            </div>}
        </div>
