...
const BuyPage = () => {
  ...
  const handelSubmit = (e) => {
    ...
    if (validatePhoneNumber(phoneNumber) && isValidPin) {
      axios
        .post("https://omepc-server.onrender.com/api/omEpc/buy/new", {
          firstName: firstName,
          lastName: lastName,
          address: address,
          city: city,
  ...
  return (
    <form
      ...
      className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 my-10 lg:px-14 gap-10 bg-gray-50 justify-center"
    >
      <div className="p-10">
        ...
        <div className="p-10 h-auto totalBox mt-10">
          ...
          <div className="overflow x-auto">
              ...
              <tbody>
                ...
                <tr className="flex mt-5 justify-between items-center px-2">
                  <td className="flex items-center">
                    ...
                    <div className="ml-5 flex items-center">
                      <AiFillMinusCircle
                        className="text-red-500 hover:text-red-700 text-2xl border-none"
                        onClick={() => {
                          if (quantity > 1) {
                      ...
                      <input
                        ...
                        value={quantity}
                        className="font-semibold border border-gray-500 w-8 text-center text-lg mx-3"
                      />

                      <HiPlusCircle
                        className="text-blue-500 hover:text-blue-700 text-2xl border-none"
                        onClick={() => setQuantuty(quantity + 1)}
                      >
                        +
                      </HiPlusCircle>
                    </div>
                ...
                <tr className="flex justify-between mt-5 px-2">
                  ...
                  <td className="font-bold">
                    ₹{quantity * price + deliveryCost}
                  </td>
                </tr>

                <tr className="flex justify-between mt-5 px-2">
                  <td className="font-bold capitalize">PAYMENT METHOD</td>
                  <td className="font-semibold capitalize text-sm">
            ...
            <div className="text-center mt-5 ">
              <input
                className="btn btn-warning w-full text-center rounded-none px-10"
                type="submit"
                value="Place order"
              />
            </div>
