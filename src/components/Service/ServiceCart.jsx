...
const ServiceCart = ({ service }) => {
  ...
  const imgUrl = `https://omepc-server.onrender.com/uploads/${service.image}`;
  ...
  return (
    <div className="card rounded-none card-compact w-96 bg-base-100 shadow-sm hover:shadow-lg transition serviceCart">
      <figure>
        <img className="serviceImg" src={imgUrl} alt="Shoes" />
      </figure>
      <div className="card-body">
        ...
        <div className="card-actions justify-start my-5">
          <button
            onClick={learnMore}
            className="btn btn-outline rounded-none capitalize font-mono text-sm"
          >
            Read more
          </button>
        </div>
