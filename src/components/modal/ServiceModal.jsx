...
const ServiceModal = ({ openModal, setOpennModal }) => {
  ...
  const [surveillanceCategory, setSurveillanceCategory] =
    useState("Check arp tables");
  ...
  const handelComputerService = (e) => {
    ...
    fetch(
      "https://omepc-server.onrender.com/api/omEpc/serviceReq/computer/new",
      {
        method: "POST",
        headers: {
  ...
  const handelPrinterService = (e) => {
    ...
    if (validatePhoneNumber(phoneNumber) && isValidPin) {
      fetch(
        "https://omepc-server.onrender.com/api/omEpc/serviceReq/printer/new",
        {
          method: "POST",
          headers: {
            Accept: "application/json, text/plain, */*",
  ...
  const handelSurveillanceService = (e) => {
    ...
    fetch(
      "https://omepc-server.onrender.com/api/omEpc/serviceReq/surveillance/new",
      {
        method: "POST",
        headers: {
          Accept: "application/json, text/plain, */*",
      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box ">
          <label
            ...
            className="btn btn-sm btn-circle bg-red-500 border-0 absolute right-2 top-2"
          >
            ✕
          </label>
          ...
          {value == 0 && (
            <form
              onSubmit={handelComputerService}
            ...
            >
              <input
                ...
                required
                className="mt-5 mb-2 input input-bordered w-full max-w-lg rounded-none"
              />
              ...
              <div className="flex space-x-2 my-3">
                ...
                <div>
                  ...
                  />
                  {phError && (
                    <div className="text-red-500 mt-2">{phError}</div>
                  )}
                </div>
              </div>
              ...
              <input
                ...
                className="my-2 input input-bordered w-full max-w-lg rounded-none"
              />
              {!isValidPin && <p className="text-red-500">{pinError}</p>}
              ...
              <div className="my-2">
                ...
                <select
                  required
                  name="category"
                  onChange={(e) => setComputerCategory(e.target.value)}
                  className="capitalize select select-bordered w-full max-w-lg rounded-none mt-2"
                >
                  {services.map((service) => (
                    <option className="capitalize" value={service.category}>
                      {service.category}
                    </option>
                  ))}
                </select>
              ...
              <div className="my-2">
                ...
                <select
                  ...
                  className="capitalize select select-bordered w-full max-w-lg rounded-none mt-2"
                >
                  <option className="capitalize" value="Desktop">
                    Desktop
                  </option>
                  <option className="capitalize" value="Laptop">
                    Laptop
                  </option>
                </select>
              </div>
              ...
              <div className="my-2">
                ...
                <select
                  ...
                  className=" select select-bordered w-full max-w-lg rounded-none mt-2"
                >
                  <option className="capitalize" value="Laptop">
                    MS-Windows
                  </option>
              ...
              <textarea
                ...
                className="textarea textarea-bordered textarea-lg w-full max-w-lg my-2 rounded-none"
              ></textarea>

              <div className="modal-action justify-start">
                <button className="btn capitalize bg-orange-500 border-none rounded-none">
                  <MdOutlineMiscellaneousServices className="mr-1"></MdOutlineMiscellaneousServices>
          ...
          {value == 1 && (
            ...
            >
              ...
              <div className="my-2">
                ...
                <select
                  name="category"
                  onChange={(e) => setUpsCategory(e.target.value)}
                  className="capitalize select select-bordered w-full max-w-lg rounded-none mt-2"
                >
                  {services.map((service) => (
                    <option className="capitalize" value={service.category}>
          ...
          {value == 3 && (
            <form
              onSubmit={handelSurveillanceService}
              className="form-control"
              action=""
            >
              <input
              ...
              <div className="my-2">
                ...
                <select
                  name="category"
                  required
                  onChange={(e) => setSurveillanceCategory(e.target.value)}
                  className="capitalize select select-bordered w-full max-w-lg rounded-none mt-2"
                >
                  {services.map((service) => (
                    <option className="capitalize" value={service.category}>
              ...
              <div className="my-2">
                ...
                <select
                  name="brand"
                  required
                  onChange={(e) => setSurveillanceBrand(e.target.value)}
                  className="capitalize select select-bordered w-full max-w-lg rounded-none mt-2"
                >
                  <option className="capitalize" value="Laptop">
                    Honeywell
