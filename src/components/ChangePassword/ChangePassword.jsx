...
const ChangePassword = () => {
  ...
  const handelChangePass = () => {
    fetch(`https://omepc-server.onrender.com/api/omEpc/forget/${email}`, {
      method: "PUT",
      body: JSON.stringify({
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url("https://i.ibb.co/XzMdW3L/bg.png")` }}
    >
      <div>
        ...
        />{" "}
        <br />
        <button onClick={handelChangePass} className="btn btn-primary">
          Sujhbmit
        </button>
      </div>
    </div>
